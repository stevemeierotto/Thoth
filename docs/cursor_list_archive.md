# cursor_list_archive.md

Archive of completed/historical sections removed from cursor_list.md on 2026-07-07. Nothing here was deleted — see cursor_list.md for active work.

## Table of contents

- [External review — documentation honesty (2026-06)](#external-review-documentation-honesty-2026-06)
- [External review — staleness & beyond backlog (2026-06-29)](#external-review-staleness-beyond-backlog-2026-06-29)
- [A1.1 — Builder API](#a11-builder-api)
- [A1.2 — Arm semantics (case table is authoritative)](#a12-arm-semantics-case-table-is-authoritative)
- [A1.3 — Deterministic timestamps](#a13-deterministic-timestamps)
- [A1.4 — Immutability (implementation watch)](#a14-immutability-implementation-watch)
- [A1.5 — E2-08 unit tests](#a15-e2-08-unit-tests)
- [A1.6 — Harness gate (evaluation-disabled, not failed)](#a16-harness-gate-evaluation-disabled-not-failed)
- [A1.7 — Exit criteria (stop before A2)](#a17-exit-criteria-stop-before-a2)
- [A1 files (expected)](#a1-files-expected)
- [A2.0 — Core invariants (A3 may rely on these)](#a20-core-invariants-a3-may-rely-on-these)
- [A2.1 — `runCaseArm` decoupling](#a21-runcasearm-decoupling)
- [A2.2 — Harness branch split](#a22-harness-branch-split)
- [A2.3 — Arm semantics (unchanged from A1.2)](#a23-arm-semantics-unchanged-from-a12)
- [A2.4 — Option A: unit test discipline](#a24-option-a-unit-test-discipline)
- [A2.5 — E2-09 / E2-09b unit tests](#a25-e2-09-e2-09b-unit-tests)
- [A2.6 — Gate contract (harness)](#a26-gate-contract-harness)
- [A2.7 — Scope-limits doc (`E2_PROTOCOL.md`)](#a27-scope-limits-doc-e2-protocolmd)
- [A2.8 — Exit criteria (stop before A3)](#a28-exit-criteria-stop-before-a3)
- [A2 files (expected)](#a2-files-expected)
- [A3.0 — Layer ownership contract](#a30-layer-ownership-contract)
- [A3.0a — Source of retrieval expectations (no new schema)](#a30a-source-of-retrieval-expectations-no-new-schema)
- [A3.0b — Schema change gate (only if A3.0a blocked)](#a30b-schema-change-gate-only-if-a30a-blocked)
- [A3.0c — Determinism responsibilities (no overlap with A1)](#a30c-determinism-responsibilities-no-overlap-with-a1)
- [A3.0d — Index contract](#a30d-index-contract)
- [A3.0e — Executive execution (harness continuity only)](#a30e-executive-execution-harness-continuity-only)
- [A3.0f — Purity (design + verified exit criterion)](#a30f-purity-design-verified-exit-criterion)
- [A3.1 — Boundary mapping](#a31-boundary-mapping)
- [A3.2 — `runCaseArm` wiring](#a32-runcasearm-wiring)
- [A3.3 — Harness branch](#a33-harness-branch)
- [A3.4 — Gate contract (harness)](#a34-gate-contract-harness)
- [A3.5 — E2-10 unit tests (four categories)](#a35-e2-10-unit-tests-four-categories)
- [A3.6 — Protocol doc (`E2_PROTOCOL.md`)](#a36-protocol-doc-e2-protocolmd)
- [A3.7 — Exit criteria (stop before A4)](#a37-exit-criteria-stop-before-a4)
- [A3 files (expected)](#a3-files-expected)
- [A4.0 — Core invariants (inherit A3)](#a40-core-invariants-inherit-a3)
- [A4.0a — STRICT retrieval context injection contract](#a40a-strict-retrieval-context-injection-contract)
- [A4.0b — Single dispatch decision point (long-term invariant)](#a40b-single-dispatch-decision-point-long-term-invariant)
- [A4.0c — STRICT retrieval context ownership (diagram)](#a40c-strict-retrieval-context-ownership-diagram)
- [A4.0d — Golden-case equivalence scope (not exhaustive)](#a40d-golden-case-equivalence-scope-not-exhaustive)
- [A4.1 — Executive wiring](#a41-executive-wiring)
- [A4.2 — Harness branch](#a42-harness-branch)
- [A4.3 — Gate contract (harness)](#a43-gate-contract-harness)
- [A4.4 — RAG bypass evidence (static + runtime — do not conflate)](#a44-rag-bypass-evidence-static-runtime-do-not-conflate)
- [A4.5 — Unit / case tests](#a45-unit-case-tests)
- [A4.6 — Exit criteria (stop before A5)](#a46-exit-criteria-stop-before-a5)
- [A4 files (expected)](#a4-files-expected)
- [A5.0 — Architectural timeline: A3 → A4 → A5](#a50-architectural-timeline-a3-a4-a5)
- [A5.0a — Two failure domains (intentional)](#a50a-two-failure-domains-intentional)
- [A5.0b — Runtime guard contract (architectural)](#a50b-runtime-guard-contract-architectural)
- [A5.0c — Signal precedence](#a50c-signal-precedence)
- [A5.0d — Why A5 is not redundant with A4](#a50d-why-a5-is-not-redundant-with-a4)
- [A5.0e — Core invariants (preserve all prior strengths)](#a50e-core-invariants-preserve-all-prior-strengths)
- [A5.0f — Blast radius (architectural)](#a50f-blast-radius-architectural)
- [A5.1 — Implementation scope (minimal)](#a51-implementation-scope-minimal)
- [A5.2 — Harness branch](#a52-harness-branch)
- [A5.3 — Gate contract (harness)](#a53-gate-contract-harness)
- [A5.4 — E2-11 and observable golden regression](#a54-e2-11-and-observable-golden-regression)
- [A5.5 — Exit criteria (stop before Phase B)](#a55-exit-criteria-stop-before-phase-b)
- [A5 files (expected)](#a5-files-expected)
- [B.0 — Problem statement (why Phase B exists)](#b0-problem-statement-why-phase-b-exists)
- [B.0a — Three-axis model (missing bridge)](#b0a-three-axis-model-missing-bridge)
- [B.0b — Precedence (mandatory logic)](#b0b-precedence-mandatory-logic)
- [B.0c — Minimal schema additions (small, critical)](#b0c-minimal-schema-additions-small-critical)
- [B.0d — Wiring: orphan signal → block layer](#b0d-wiring-orphan-signal-block-layer)
- [B.1 — Checkpoint sequence (implement in order)](#b1-checkpoint-sequence-implement-in-order)
- [B.1.0 — B1 implementation plan (schema phase — **v2**)](#b10-b1-implementation-plan-schema-phase-v2)
- [B.2.0 — B2 implementation plan (run-block capture wiring — **v3**)](#b20-b2-implementation-plan-run-block-capture-wiring-v3)
- [B.2.1 — Pre-B3 stabilization plan (transport integrity — **v3**)](#b21-pre-b3-stabilization-plan-transport-integrity-v3)
- [B.3.0 — B3 implementation plan (evaluation interpretation — **v4.1**)](#b30-b3-implementation-plan-evaluation-interpretation-v41)
- [B.3.1 — Planned architectural refactor (post–Phase B — **not B3**)](#b31-planned-architectural-refactor-postphase-b-not-b3)
- [B.4.0 — B4 implementation plan (JSONL export — **v1**)](#b40-b4-implementation-plan-jsonl-export-v1)
- [B.5.0 — B5 implementation plan (official harness switch — **v4**)](#b50-b5-implementation-plan-official-harness-switch-v4)
- [B.6.0 — B6 implementation plan (golden baseline archive — **v1**)](#b60-b6-implementation-plan-golden-baseline-archive-v1)
- [C.0.0 — Phase C implementation plan (integration tier — **v1.1**)](#c00-phase-c-implementation-plan-integration-tier-v11)
- [C.1.0 — C1 implementation plan (evaluation service boundary — **v1**)](#c10-c1-implementation-plan-evaluation-service-boundary-v1)
- [C.2.0 — C2 implementation plan (episode publication — **v1**)](#c20-c2-implementation-plan-episode-publication-v1)
- [C.3.0 — E2-C3 implementation plan (diagnostic layer — **v1.1**)](#c30-e2-c3-implementation-plan-diagnostic-layer-v11)
- [C.4.0 — E2-C4 implementation plan (telemetry layer — **v1**)](#c40-e2-c4-implementation-plan-telemetry-layer-v1)
- [C.5.0 — E2-C5 implementation plan (path equivalence — **v1 locked**)](#c50-e2-c5-implementation-plan-path-equivalence-v1-locked)
- [D.1.0 — E2-D1 implementation plan (event channel maturity — **v1 locked**)](#d10-e2-d1-implementation-plan-event-channel-maturity-v1-locked)
- [D.1.1 — D1 → D2 gate addendum (2026-07-06)](#d11-d1-d2-gate-addendum-2026-07-06)
- [D.2.0 — E2-D2 implementation plan (replay subscriber — **v1 locked**)](#d20-e2-d2-implementation-plan-replay-subscriber-v1-locked)
- [D.2.1 — D2-03 / FLAKE-UT-02 execution record (reliability close-out — **complete**)](#d21-d2-03-flake-ut-02-execution-record-reliability-close-out-complete)
- [B.3 — Gate contract (official run)](#b3-gate-contract-official-run)
- [B.4 — Tests](#b4-tests)
- [B.5 — Exit criteria (stop before Phase C)](#b5-exit-criteria-stop-before-phase-c)
- [B files (expected)](#b-files-expected)
- [C1 — Planning quality (context management)](#c1-planning-quality-context-management)
- [C2 — Retrieval ranking & chat RAG observability](#c2-retrieval-ranking-chat-rag-observability)
- [C3 — Reflection A/B measurement](#c3-reflection-ab-measurement)
- [C5 — Robustness & failure tests](#c5-robustness-failure-tests)
- [C4 — Developer & CI latency](#c4-developer-ci-latency)
- [C7 — Runtime latency (production goals)](#c7-runtime-latency-production-goals)
- [C4 & C7 — Latency (developer vs runtime) ✅ complete](#c4-c7-latency-developer-vs-runtime-complete)

---

<a id="external-review-documentation-honesty-2026-06"></a>
...
<a id="external-review-staleness-beyond-backlog-2026-06-29"></a>
...
<a id="a12-arm-semantics-case-table-is-authoritative"></a>
...
<a id="a13-deterministic-timestamps"></a>
...
<a id="a14-immutability-implementation-watch"></a>
...
<a id="a16-harness-gate-evaluation-disabled-not-failed"></a>
...
<a id="a17-exit-criteria-stop-before-a2"></a>
...
<a id="a20-core-invariants-a3-may-rely-on-these"></a>
...
<a id="a21-runcasearm-decoupling"></a>
...
<a id="a22-harness-branch-split"></a>
...
<a id="a23-arm-semantics-unchanged-from-a12"></a>
...
<a id="a24-option-a-unit-test-discipline"></a>
...
<a id="a25-e2-09-e2-09b-unit-tests"></a>
...
<a id="a26-gate-contract-harness"></a>
...
<a id="a27-scope-limits-doc-e2-protocolmd"></a>
...
<a id="a28-exit-criteria-stop-before-a3"></a>
...
<a id="a30-layer-ownership-contract"></a>
...
<a id="a30a-source-of-retrieval-expectations-no-new-schema"></a>
...
<a id="a30b-schema-change-gate-only-if-a30a-blocked"></a>
...
<a id="a30c-determinism-responsibilities-no-overlap-with-a1"></a>
...
<a id="a30e-executive-execution-harness-continuity-only"></a>
...
<a id="a30f-purity-design-verified-exit-criterion"></a>
...
<a id="a34-gate-contract-harness"></a>
...
<a id="a35-e2-10-unit-tests-four-categories"></a>
...
<a id="a36-protocol-doc-e2-protocolmd"></a>
...
<a id="a37-exit-criteria-stop-before-a4"></a>
...
<a id="a40-core-invariants-inherit-a3"></a>
...
<a id="a40a-strict-retrieval-context-injection-contract"></a>
...
<a id="a40b-single-dispatch-decision-point-long-term-invariant"></a>
...
<a id="a40c-strict-retrieval-context-ownership-diagram"></a>
...
<a id="a40d-golden-case-equivalence-scope-not-exhaustive"></a>
...
<a id="a43-gate-contract-harness"></a>
...
<a id="a44-rag-bypass-evidence-static-runtime-do-not-conflate"></a>
...
<a id="a46-exit-criteria-stop-before-a5"></a>
...
<a id="a50-architectural-timeline-a3-a4-a5"></a>
...
<a id="a50a-two-failure-domains-intentional"></a>
...
<a id="a50b-runtime-guard-contract-architectural"></a>
...
<a id="a50d-why-a5-is-not-redundant-with-a4"></a>
...
<a id="a50e-core-invariants-preserve-all-prior-strengths"></a>
...
<a id="a50f-blast-radius-architectural"></a>
...
<a id="a51-implementation-scope-minimal"></a>
...
<a id="a53-gate-contract-harness"></a>
...
<a id="a54-e2-11-and-observable-golden-regression"></a>
...
<a id="a55-exit-criteria-stop-before-phase-b"></a>
...
<a id="b0-problem-statement-why-phase-b-exists"></a>
...
<a id="b0a-three-axis-model-missing-bridge"></a>
...
<a id="b0b-precedence-mandatory-logic"></a>
...
<a id="b0c-minimal-schema-additions-small-critical"></a>
...
<a id="b0d-wiring-orphan-signal-block-layer"></a>
...
<a id="b1-checkpoint-sequence-implement-in-order"></a>
...
<a id="b10-b1-implementation-plan-schema-phase-v2"></a>
...
<a id="b20-b2-implementation-plan-run-block-capture-wiring-v3"></a>
...
<a id="b21-pre-b3-stabilization-plan-transport-integrity-v3"></a>
...
<a id="b30-b3-implementation-plan-evaluation-interpretation-v41"></a>
...
<a id="b31-planned-architectural-refactor-postphase-b-not-b3"></a>
...
<a id="b40-b4-implementation-plan-jsonl-export-v1"></a>
...
<a id="b50-b5-implementation-plan-official-harness-switch-v4"></a>
...
<a id="b60-b6-implementation-plan-golden-baseline-archive-v1"></a>
...
<a id="c00-phase-c-implementation-plan-integration-tier-v11"></a>
...
<a id="c10-c1-implementation-plan-evaluation-service-boundary-v1"></a>
...
<a id="c20-c2-implementation-plan-episode-publication-v1"></a>
...
<a id="c30-e2-c3-implementation-plan-diagnostic-layer-v11"></a>
...
<a id="c40-e2-c4-implementation-plan-telemetry-layer-v1"></a>
...
<a id="c50-e2-c5-implementation-plan-path-equivalence-v1-locked"></a>
...
---
<a id="d10-e2-d1-implementation-plan-event-channel-maturity-v1-locked"></a>
#### D.1.0 — E2-D1 implementation plan (event channel maturity — **v1 locked**)

**Authority:** [`docs/D_PHASE_PROTOCOL.md`](D_PHASE_PROTOCOL.md) § D1  
**One problem:** Prove multi-subscriber fan-out without coupling the Executive to consumer count.

**C2 proved:** One subscriber, channel isolation, Executive has no eval import.  
**D1 proves:** N subscribers, Executive-path failure isolation, invisibility invariant (0 vs N → identical Executive work).

##### One sentence

> **D1 is a proof, not a feature.** Prove zero, one, or many subscribers consume the same immutable `EpisodeCompleted` while the Executive performs identical work — without knowing how many consumers exist.

##### D1 invisibility invariant

> **Subscriber count must be invisible to the Executive.**

Whether **0**, **one**, or **fifty** subscribers exist, the Executive publishes exactly one event and performs **identical work** (terminal outcome + emitted payload).

##### Architectural target

```
Executive → one immutable EpisodeCompleted (fire-and-forget)
    ▼
InProcessEpisodeEventChannel (FIFO delivery, per-subscriber failure isolation)
    ├── EvaluationSubscriber (existing — unchanged)
    └── Test subscribers (D1 proof only)
```
...
| Step | Work | Gate |
|------|------|------|
| **1** | Registry contract — FIFO delivery order documented; immutability; channel purity (no eval/diag/telemetry imports); optional `subscriberCountForTests()` | Build green |
| **2** | E2-D1-01 — N capture subscribers; byte-identical payload across all | D1-01 green |
| **3** | E2-D1-02 — **mandatory Executive-path** failure isolation (see below) | D1-02 green |
| **4** | E2-D1-03 — invisibility audit + behavioral outcome comparison (see below) | D1-03 green |
| **5** | Regression — E2-C1..C5, `THOTH_E2_C5=1`, `wiring_stage=B` | Full green; pause before D2 |

**Gate env:** `THOTH_E2_D1=1` (proposed)

##### Step 3 — E2-D1-02 (mandatory Executive path)

Channel-only publish proves the channel swallows exceptions; it does **not** prove Passive Consumer Law §4 (*cannot become required for successful execution*) on the **Executive**.

**Required proof (not optional):**

1. Register throwing subscriber + healthy capture subscriber on wired channel  
2. Run **one goal to completion** through `ExecutiveController` with `enable_episodic_evaluation_publication=true`  
3. Assert throwing subscriber failure is logged/isolated; healthy subscriber still receives event  
4. Assert Executive **terminal state / goal outcome** (`PLAN_COMPLETED` or equivalent terminal) is **identical** to the same goal run with **no** throwing subscriber (baseline: 0 extra subscribers or non-throwing registry only)

Same rigor as C2's Executive-source audit — D1 must not regress it.

##### Step 4 — E2-D1-03 (outcome + payload, not payload alone)

Identical emitted `EpisodeCompleted` at 0 vs N subscribers is **necessary but not sufficient**. The invariant is identical **Executive work**, not merely identical event construction.

**Structural audit** (`executive_controller.cpp` / `.h`):

- No subscriber count or consumer identity branching  
- No `subscribers_` access from Executive  
- **Passive Consumer Law §3 traceability:** no channel/subscriber coupling that could influence execution ordering (subsumed by structural audit — document explicitly for D5 full law audit)

**Behavioral proof (both required):**

| Assertion | Compare 0-subscriber vs N-subscriber runs |
|-----------|-------------------------------------------|
| **A — Executive outcome** | Terminal state / goal completion identical |
| **B — Emitted event** | `EpisodeCompleted` fields identical (plan_id, terminal_state, snapshots, attribution) |

##### Preregistered tests

| ID | Asserts |
|----|---------|
| E2-D1-01 | Multi-subscriber delivery; byte-identical immutable event at all subscribers |
| E2-D1-02 | **Executive-path mandatory:** goal completes; terminal state unchanged with throwing subscriber; healthy subscriber delivered |
| E2-D1-03 | Structural invisibility audit (incl. Passive Consumer Law §3 comment) + behavioral A+B above |

##### Files

| File | Change |
|------|--------|
| `episode_event_channel.h/.cpp` | Registry hardening; test seam if needed |
| `episode_events.h` | Delivery contract documentation |
| `tests/unit_tests.cpp` | E2-D1-01..03 |
| `executive_controller.*` | **Untouched** unless audit finds violation |

| Untouched | |
|-----------|--|
| `evaluation_subscriber.*`, `episodic_evaluation_service.*`, `e2_path_equivalence.*` | |

##### Forbidden

- Executive branching on subscriber count or consumer type  
- Synchronous subscriber completion as publication gate  
- Channel importing eval/diag/telemetry semantics  
- Channel-only proof substituting for Executive-path E2-D1-02  
- Payload-only comparison substituting for Executive-outcome E2-D1-03  
...
|------|------------|
| `ReplaySubscriber` | D2 |
| `MetricsSubscriber` / `TraceSubscriber` | D3 |
| Live INTEGRATION connection | D4 |
| GUI wiring | Consumer consequence |

**Time estimate:** 3–5 h.

**Status:** ✅ **E2-D1 complete** (2026-07-05). E2-D1-01..03 green; `THOTH_E2_C5=1` unchanged. **G1/G2 green** (2026-07-06). **D2 plan locked** — § D.2.0.

---
<a id="d11-d1-d2-gate-addendum-2026-07-06"></a>
#### D.1.1 — D1 → D2 gate addendum (2026-07-06)

**D1 correctness:** Cleared on its own merits (`THOTH_E2_D1=1`, path equivalence unchanged).

**Do not conflate with:** (a) PR/CTest regression gate, (b) unrelated unit-test flakes below.

##### Required before opening D2

| # | Gate | Status |
|---|------|--------|
| **G1** | `tests/CMakeLists.txt` — `thoth-unit-tests` CTest `TIMEOUT` ≥ observed wall time (~17 min with D1; was 600s vs ~930–1005s actual) | ✅ **1800s** — reconfigure verified in `CTestTestfile.cmake` |
| **G2** | `ctest -R thoth-unit-tests` passes **in budget** (not only direct `./tests/thoth-unit-tests`) | ✅ **Passed 2026-07-06** — **994.5s** (within 1800s budget); FLAKE-UT-01 fix verified |

**Sequence:** Fix G1 → confirm G2 → then open D2. D1 checkpoint claims do not substitute for a red `pr` label.

##### Optional structural fix (not a substitute for G1)

**`buildOfficialGoldenSummary()` caching** across B5/C1/C3/C4/C5 — highest leverage for wall time, but **risk:** shared summary across nominally independent tests can pollute boundaries (cf. A3 purity, E2-09b ownership). If adopted: **read-only cache**, no mutation by consumers, plus determinism proof (cached ≡ fresh-compute, same as A1/A3 byte-identical discipline). Do not trade slow-but-honest for fast-but-stale without that guardrail.

##### Known open items — **not** part of D1 close-out (separate investigation)

| ID | Priority | Symptom | Scope | Status |
|----|----------|---------|-------|--------|
| **FLAKE-UT-01** | High | `testParallelRetrieval` (main index **43**) — race: `max_concurrent=0` or `completed=false` while `max>=2` | `tests/unit_tests.cpp` `testParallelRetrieval` | ✅ **Resolved 2026-07-06** — reflection disabled; 60s terminal-state wait; split assertions; isolated 20/20 + G2 green |
| **FLAKE-UT-02** | **Critical** | `nlohmann::json` debug assert: `m_data.m_value.string != nullptr` during full suite run | First writer: `testMemoryPruning` → `consolidateSessionBatch` (~37s); crash marker: GRAG summary (~386s) | ✅ **Resolved 2026-07-07** — SQLITE_STATIC UAF; fix `basic_agent` `27192fd`, Thoth `2993fb3`; § **D.2.1** |

**FLAKE-UT-02 / D2 boundary:** FLAKE-UT-02 was a **reliability item** separate from D2 architectural proof; investigation closed under **D2-03** without coupling to D3.

**Regression note (2026-07-06):** Full-suite “hang” was **CTest SIGKILL at 600s**, not deadlock. Suite completes ~**16–17 min** direct; at 600s cutoff still in E2-B5/C-phase block (index ~113), **before** E2-D1 tests. Pre-D1 (`f639d00` `unit_tests.cpp`) also **>600s**. D1 adds ~75s; no subscriber leak / static channel state found.

---
<a id="d20-e2-d2-implementation-plan-replay-subscriber-v1-locked"></a>
#### D.2.0 — E2-D2 implementation plan (replay subscriber — **v1 locked**)

**Authority:** [`docs/D_PHASE_PROTOCOL.md`](D_PHASE_PROTOCOL.md) § D2  
**Prerequisites:** D1 complete; G1/G2 green (§ D.1.1)  
**Estimate:** 3–4 h  
**FLAKE-UT-02:** ✅ **Resolved** (2026-07-07) — see § **D.2.1** execution record. Was reliability-only; did not affect D2 architectural proof.

##### One sentence

> **D2 is a proof, not a feature.** Prove completed episodes can be **re-observed** (replay changes **time**) for debugging without mutating execution, evaluation state, or benchmark authority — and **without** republishing into the event channel.

##### What D1 proved vs what D2 must add

| Already proven (D1) | D2 must add |
|---------------------|-------------|
| Multi-subscriber fan-out on immutable `EpisodeCompleted` | **Replay** as a distinct consumer — capture + internal re-observation without re-execution |
| Executive-path failure isolation | Replay is **idempotent** on captured input; replay does **not** grow capture buffer |
| Subscriber count invisible to Executive | Unregistering replay does not change `wiring_stage=B` results (Passive Consumer Law §5) |
| Channel FIFO + per-subscriber isolation | Replay state is **subscriber-owned**; `EvaluationService` stays stateless |

**Why separate from D3:** Replay changes **time** (re-observation). Metrics/trace change **observation** (measurement).
...
Executive
    ...
    ▼
InProcessEpisodeEventChannel
    ├── EvaluationSubscriber     (existing — unchanged)
    └── ReplaySubscriber (D2)
            │ live: append immutable copy → append-only FIFO
            │ replay: ReplaySink / replay callback (internal only)
            ▼
        never IEpisodeEventChannel::publish()
```

The Executive still knows nothing. The Event Channel still knows nothing. Replay owns replay.

##### Replay semantics (locked)

| Mode | Input | Output |
|------|-------|--------|
| **Live capture** | `onEpisodeCompleted(const EpisodeCompleted&)` | Append immutable copy to subscriber-owned **append-only FIFO** |
| **Deterministic replay** | `replayCaptured(index)` | Deliver **same bytes** to replay sink/callback only — **not** channel republication |

**Storage (D2):** Append-only FIFO only. No `plan_id` indexing in D2 — proof is replay, not search.  
**Replay API (D2):** `replayCaptured(index)` **only** — defer `replayAll()` and bulk ordering obligations.  
**JSONL:** Optional observational sink only (`event_type` e.g. `E2_EPISODE_REPLAY`). Capture is mandatory; JSONL is not part of the replay proof.  
**Input scope:** Published `EpisodeCompleted` snapshots. Sealed benchmark injection logs (M4 range-restore) out of scope unless explicitly added later.

##### Production wiring (locked)

Register in `basic_agent_plugin` behind config flag — mirror `EvaluationSubscriber` pattern:

| Config | Default |
|--------|---------|
| `enable_episode_replay_subscriber` | `false` |

Proves production wiring with zero runtime behavior until enabled. D4 needs only `flag=true`, not new plumbing.

##### Implementation order (pause between steps)

| Step | Work | Gate |
|------|------|------|
| **1** | `replay_subscriber.h` / `.cpp` — `IEpisodeEventSubscriber`; append-only FIFO capture; `replayCaptured(index)` → internal sink; optional JSONL; no eval/Executive imports; **never** `publish()` on channel | Build green |
| **2** | **E2-D2-01** — idempotence + coexistence + structural audit (see below) | D2-01 green |
| **3** | **E2-D2-02** — benchmark authority isolation (see below) | D2-02 green |
| **4** | Plugin registration + `enable_episode_replay_subscriber=false` default | Build green |
| **5** | Regression — `THOTH_E2_D2=1`, `THOTH_E2_D1=1`, `THOTH_E2_C5=1`, G2 `ctest` | Full green; pause before D3 |

**Gate env:** `THOTH_E2_D2=1` (proposed)

##### E2-D2-01 (idempotence + coexistence — no E2-D2-03)

1. Register `ReplaySubscriber` **and** `EvaluationSubscriber` on same channel  
2. Publish fixture `EpisodeCompleted`  
3. Assert capture count == 1; `capturedAt(0)` byte-identical to published fixture  
4. Call `replayCaptured(0)` **twice**  
5. Assert replay sink receives **identical** payloads both times (replay output idempotent)  
6. **Replay idempotence invariant (three parts):**
   - **Storage size unchanged:** `captureCount() == 1` after any number of replays  
   - **Stored object unchanged:** `capturedAt(0)` byte-identical to fixture before and after every replay (replay is read-only on buffer)  
   - **Replay payload unchanged:** sink payloads byte-identical across replays  
7. **Append-only invariant:** `captureCount()` unchanged after any number of replay operations (architectural invariant for D3+ replay tooling)  
8. **Coexistence:** `ReplaySubscriber` presence produces **no observable change** in `EvaluationSubscriber` outputs vs eval-only baseline (behavioral proof — not implementation-specific)  
9. **Structural audit:** no Executive/eval imports; forbidden symbols (`publish(`, `ExecutiveController`, `resolveEvaluation`, `execute_goal`); **no channel handle:** `ReplaySubscriber` must not contain `IEpisodeEventChannel*`, `IEpisodeEventChannel&`, or `std::shared_ptr<IEpisodeEventChannel>` (replay must never invoke channel callbacks)

##### E2-D2-02 (Passive Consumer Law §5)

1. **Baseline:** `THOTH_E2_WIRING_STAGE=B` harness with replay **unregistered** — record outcome + Phase B scoped fields  
2. **With replay:** Same harness with replay registered (flag on test channel or production path) — outcome **unchanged**  
3. **Removal:** Unregister / destroy replay — re-run — **unchanged** vs baseline  
4. Assert replay sink/JSONL contains **no** `official_scoring: true`, `e2_outcome`, or `evaluation_resolution` authority fields

##### Forbidden (D2)

- **`ReplaySubscriber` must never call `publish()` on `IEpisodeEventChannel`**
- Replay mutating `EpisodeCompleted` or publisher state  
- Replay as prerequisite for goal success or benchmark completion  
...
- Blocking channel delivery on replay buffer failure  
- `replayAll()` or `plan_id` keyed storage in D2  
- Describing replay as channel “re-emit” / republication  

##### Exit criteria (D2 complete)

1. `ReplaySubscriber` exists; Passive Consumer Law satisfied  
2. **Replay idempotence invariant:** replaying does **not** increase stored episode count  
3. E2-D2-01..02 green (coexistence inside D2-01)  
4. `enable_episode_replay_subscriber=false` registered in production wiring  
5. `THOTH_E2_C5=1` unchanged; `wiring_stage=B` fingerprint stable; G2 green  
6. **D2-03 / FLAKE-UT-02 resolved** (§ **D.2.1**)  
7. **Pause before D3**
...
| File | Change |
|------|--------|
| `replay_subscriber.h` / `.cpp` | **New** |
| `external/basic_agent/CMakeLists.txt` | Add sources |
| `basic_agent_plugin.cpp` | Flag-gated registration |
| `config.h` / `config.cpp` | `enable_episode_replay_subscriber` |
| `tests/unit_tests.cpp` | E2-D2-01..02 + gate |
| `docs/D_PHASE_PROTOCOL.md` | § D2 refinements |
| `docs/cursor_list.md` | § D.2.0 (this section) |

| Untouched | |
|-----------|--|
| `evaluation_subscriber.*`, `episodic_evaluation_service.*`, `executive_controller.*` | Semantics frozen |
| `e2_path_equivalence.*` | Re-run only |

**Status:** 🔒 **v1 locked** (2026-07-06). **D2 complete** (2026-07-06). **D2-03 / FLAKE-UT-02 resolved** (2026-07-07). **Paused before D3.**

##### Project state (official)
...
| D1 | ✅ Complete |
| G1/G2 | ✅ Green |
| D2 Protocol v1 | ✅ Locked |
| D2 Step 1 | ✅ Skeleton |
| D2 Step 2 / E2-D2-01 | ✅ Idempotence + coexistence + structural audit |
| D2 Step 3 / E2-D2-02 | ✅ Benchmark authority isolation (Passive Consumer Law §5) |
| D2 Step 5 | ✅ `THOTH_E2_D2=1`, `THOTH_E2_D1=1`, `THOTH_E2_C5=1`, G2 `ctest` green (post D2-03 fix: 3 consecutive passes) |
| D2-03 / FLAKE-UT-02 | ✅ Resolved 2026-07-07 — § **D.2.1** |

---
<a id="d21-d2-03-flake-ut-02-execution-record-reliability-close-out-complete"></a>
#### D.2.1 — D2-03 / FLAKE-UT-02 execution record (reliability close-out — **complete**)

**ID:** **FLAKE-UT-02** (not E2-D2 replay checkpoint — D2 protocol stops at E2-D2-01..02)  
**Status:** ✅ **Resolved** (2026-07-07)  
**Commits:** `external/basic_agent` **`27192fd`** (`Fix heap-use-after-free in consolidation metadata SQLite bind`); Thoth **`2993fb3`** (submodule pointer bump)

##### Symptom (original)

G2 `ctest` attempt 1 @ **386s** — `nlohmann::json` `assert_invariant`: `m_data.m_value.string != nullptr`. Last stdout before abort: GRAG vs RAG benchmark summary (`testBenchmarkReporter` / `reportToStdout`). That output was a **crash location marker**, not the corrupting writer.

##### Investigation summary (Steps 1–4)

| Step | Planned goal | Outcome |
|------|--------------|---------|
| **1 — Freeze** | Locate last safe region before assert | Freeze boundary locked: after GRAG summary → `testProblemStatePersistence` and successors; single-threaded on green runs |
| **2 — Ownership guards** | First null `nlohmann::json` string | Guards on freeze-region + `ExecutiveController` paths; **no trips** on isolated stress (instrumentation on `wip/flake-ut02-instrumentation`) |
| **3 — GRAG audit** | JSON ownership bugs in benchmark path | **GRAG benchmark path ruled out** — `reportToStdout` has no JSON; `BenchmarkRunner` uses C++ structs only |
| **4 — Pattern classify** | A/B/C JSON ownership patterns | **Reclassified** — not a `nlohmann::json` ownership bug; delayed heap corruption from earlier writer |

##### Final root cause

| Item | Detail |
|------|--------|
| **Site** | `SQLiteMemoryRepository::consolidateSessionBatch()` — `sqlite_memory_repository.cpp` bind of `metadata_json` column |
| **Bug** | `sqlite3_bind_text(..., metadata.dump().c_str(), -1, SQLITE_STATIC)` — pointer to **temporary** `dump()` string |
| **Mechanism** | `SQLITE_STATIC` does **not** copy; buffer must outlive `sqlite3_step()`. Temporary destroyed at end of bind statement; SQLite reads freed memory during `sqlite3_step()` |
| **First writer** | `testMemoryPruning` → `MemoryPruner::consolidateOneBatch()` (~**37s** into full suite) |
| **Confirmation** | AddressSanitizer **heap-use-after-free** on full suite (pre-fix); absent post-fix |

##### Root cause classification

- **Delayed heap corruption due to object lifetime** (SQLite bind lifetime violation)
- **Not** a `nlohmann::json` ownership / move bug
- **GRAG benchmark path ruled out** as corrupting writer
- JSON assert @ ~386s was a **downstream symptom** of earlier heap damage

##### Resolution

Introduced a named loop-local string to preserve `dump()` output through statement execution:
...
Same lifetime pattern as existing `parentJson` bind in the same function. **No** change to serialized JSON content, SQL, transaction ordering, or persistence semantics — **buffer lifetime only**.

##### Verification (post-fix)

| Gate | Result |
|------|--------|
| **ASan full suite** | Green — no heap-use-after-free at `consolidateSessionBatch` |
| **G2 `ctest`** | **3 consecutive passes** (runs 2–4; run 1 was 1800s timeout under parallel stress contention — excluded) |
| **`THOTH_FLAKE_UT02_STRESS=100`** | 100/100 green (debug, with instrumentation enabled) |

##### Investigation instrumentation

| Location | Disposition |
|----------|-------------|
| `flake_ut02_diagnostics.h`, `ExecutiveController` hooks, instrumented `unit_tests.cpp` stress gate | **Not on `main`** — preserved on branches `wip/flake-ut02-instrumentation` (Thoth `0585e7c`; `basic_agent` `5fde985`) |
| Production / working branch | Instrumentation **removed**; no env-gated guards in shipped paths |

##### Exit criteria (D2-03 close)

| # | Criterion | Met |
|---|-----------|-----|
| 1 | Triggering test identified | ✅ `testMemoryPruning` → `consolidateSessionBatch:1287` |
| 2 | Root cause classified | ✅ Delayed heap corruption / SQLite `SQLITE_STATIC` lifetime |
| 3 | Minimal fix landed | ✅ `metadataJson` lifetime pin; commits above |
| 4 | G2 green 3 consecutive | ✅ (excluding resource-contention timeout) |
| 5 | Instrumentation removed or gated | ✅ Removed from production; retained on diagnostic branch |

**Next:** **D3 Step 2** — E2-D3-01 metrics sink-only (plan approved § D.3.0); await explicit implementation authorization.
...
<a id="b3-gate-contract-official-run"></a>
...
<a id="b5-exit-criteria-stop-before-phase-c"></a>
...
<a id="c1-planning-quality-context-management"></a>
...
<a id="c2-retrieval-ranking-chat-rag-observability"></a>
...
<a id="c3-reflection-ab-measurement"></a>
...
<a id="c5-robustness-failure-tests"></a>
...
<a id="c4-developer-ci-latency"></a>
...
<a id="c7-runtime-latency-production-goals"></a>
...
<a id="c4-c7-latency-developer-vs-runtime-complete"></a>
