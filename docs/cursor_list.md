...
|----|---------|-----------|
| **E1** | **Benchmark environment pinning** | Checkpoints **A–C ✅**, **D1–D4 ✅**. Spec: **`docs/benchmark_environment.md`**. Next: **D5** (`run_grag_benchmark`). |
...
| **E1** | Benchmark environment pinning | 🔶 | A–C ✅, **D1–D4 ✅** — test suite + reflection A/B + robustness + chat-RAG wired; E1-12/13/14/15 smoke. Next: **D5** — **`docs/benchmark_environment.md`** |
...
Next    E1 — environment pinning (A–C, D1–D4 done; D5 `run_grag_benchmark` next)
